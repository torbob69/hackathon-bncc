...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://koperalink.vercel.app/"],
...
app.include_router(admin_farmers_router, prefix="/api")
app.include_router(admin_funds_router, prefix="/api")
app.include_router(admin_loans_router, prefix="/api")
app.include_router(admin_oversight_router, prefix="/api")
app.include_router(farmer_loans_router, prefix="/api")
app.include_router(farmers_router, prefix="/api")
app.include_router(intakes_router, prefix="/api")
app.include_router(orders_router, prefix="/api")
app.include_router(commodities_router, prefix="/api")
app.include_router(koperasi_router, prefix="/api")
